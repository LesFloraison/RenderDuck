...
There are always plenty of things to do, if you'd like to chip in! Check out the [issues](https://github.com/baldurk/riderduck/issues) for outstanding feature requests.

If you have a change you'd like to see make it into mainline, create a fork of riderduck, make your changes to a branch, and open a pull request on github. You can look around for instructions on that - it's pretty simple.
