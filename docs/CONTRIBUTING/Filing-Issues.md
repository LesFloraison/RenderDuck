...
As a general rule for all issues: RiderDuck is a tool for debugging your programs, not for copyright infringement. If your problem or request relates to capturing copyrighted applications that are not your own then you will find no help here and your issue will be immediately closed.
:warning: :warning: :warning: :warning: :warning: :warning:
