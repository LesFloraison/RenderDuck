...
| :warning: | **I have fixed the version used for RiderDuck at [clang-format-15.0](https://github.com/llvm/llvm-project/releases/tag/llvmorg-15.0.7).** | :warning: |
...
There are instructions on how to set up git hooks or IDE integration [on the wiki](https://github.com/baldurk/riderduck/wiki/Code-formatting-(using-clang-format)).
