...
if "%1" == "htmlhelp" (
	...
	copy riderduck.hhk %BUILDDIR%\htmlhelp\
	...
	type %BUILDDIR%\htmlhelp\riderduck.hhc | python remove_lines.py ".html#" | python remove_lines.py "\"index.html\"" > %BUILDDIR%\htmlhelp\tmp
	move %BUILDDIR%\htmlhelp\tmp %BUILDDIR%\htmlhelp\riderduck.hhc
       if NOT "%HHCBUILD%" == "" (
