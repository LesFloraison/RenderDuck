...
# -*- coding: utf-8 -*-
#
# RiderDuck documentation build configuration file, created by
...
with open('../riderduck/api/replay/version.h') as f:
    for line in f:
        if line.find('#define RIDERDUCK_VERSION_MAJOR') >= 0:
            major_version = line.split()[2]
        if line.find('#define RIDERDUCK_VERSION_MINOR') >= 0:
...
html_title = 'RiderDuck documentation'
...
latex_documents = [
    (master_doc, 'RiderDuck.tex', 'RiderDuck Documentation',
...
man_pages = [
    (master_doc, 'riderduck', 'RiderDuck Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'RiderDuck', 'RiderDuck Documentation',
     author, 'RiderDuck', 'One line description of project.',
     'Miscellaneous'),
]
...
def build_finished(app, exception):
    ...
    items = []
    for module_name in ['riderduck', 'qriderduck']:
