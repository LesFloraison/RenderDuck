...
The currently selected event is highlighted and indicated with a green flag |flag_green|. This is the event that RiderDuck is inspecting and is reflected in all the other windows of the UI.
