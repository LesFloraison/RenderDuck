...
The texture viewer is likely the most intuitive window in RiderDuck and commonly the most regularly used. It displays the contents of any texture in its current state at the given event, as well as providing controls to adjust and inspect it in different ways.
