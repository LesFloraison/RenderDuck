...
%module(docstring="This is the API to QRiderDuck's high-level UI panels and functionality.") qriderduck
...
// import the riderduck interface that we depend on
%import "riderduck.i"
...
%extend IReplayManager {
  void BlockInvoke(InvokeCallback m) {
    ...
    if(globals)
      global_internal_handle = PyDict_GetItemString(globals, "_riderduck_internal");
