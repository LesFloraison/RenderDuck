...
class TargetControl():
    ...
    def captures(self):
        """Return a list of riderduck.NewCaptureData with captures made."""
        return self._captures

    def children(self):
        """Return a list of riderduck.NewChildData with any child processes created."""
...
def run_executable(exe: str, cmdline: str,
    ...
    """
    Runs an executable with RiderDuck injected, and returns the control ident.
    ...
    :param opts: An instance of riderduck.CaptureOptions.
    :return:
    """
    if envmods is None:
        envmods = []
