  ...
  for(var i=0; i < lines.length; i++) {
    ...
    if(m) {
      if(m[1] == '##') {
        ...
        title = title.replace(commit, '<a href="https://github.com/baldurk/riderduck/commit/' + commit + '">' + commit.substr(0, 8) + '</a>');
      ...
      if(indiff) {
        ...
        if(frame)
          html += `File <a href="https://github.com/baldurk/riderduck/blob/${commit}/${basepath}${frame[1]}#L${frame[2]}">"${frame[1]}", line ${frame[2]}</a>, in ${frame[3]}\n`;
        else
