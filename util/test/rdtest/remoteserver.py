...
class AndroidRemoteServer(RemoteServer):
    ...
    ADRD_SERVER_APP64 = 'org.riderduck.riderduckcmd.arm64'
    ...
    def get_riderduck_path(self):
        return self._data_path + '/' + AndroidRemoteServer.ADRD_SERVER_APP64 + '/files/RiderDuck/'
    ...
    def run_demos(self, args: [str], timeout=10):
        ...
        proc = subprocess.run(['adb', '-s', self.device,
                               ...
                               '-e', 'demos', 'RiderDuck', '-e', 'rd_demos'] + args,
    ...
    def inject_and_run_exe(self, cmdline, envmods, opts):
        ...
        args = "-e demos RiderDuck -e rd_demos \'\"" + cmdline + "\"\'"
    ...
    def retrieve_latest_test_log(self, dst, timeout=10):
        ...
        src = self._base_path + '/RiderDuck'
        raw = subprocess.run(['adb', '-s', self.device, 'shell', f'cd {src}; ls -t RiderDuck_* | head -1'],
                             check=True, stdout=subprocess.PIPE, timeout=timeout).stdout
    ...
    def retrieve_comms_log(self, timeout=10):
        ...
        src = self.get_riderduck_path() + "RemoteServer_Server.log"
        ...
        dst = os.path.join(util.get_tmp_dir(), 'RiderDuck_Server.log')
